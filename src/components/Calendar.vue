...
export default {
    ...
    methods: {
        ...
        currentDateClass(num) {
            const calendarFullDate = new Date(this.cuurentYear, this.currentMonth, num).toDateString();
    ...
    computed: {
        currentMonthName() {
            return new Date(this.cuurentYear, this.currentMonth).toLocaleString("default", {month: "long"});
        }
    }
}
</script>
